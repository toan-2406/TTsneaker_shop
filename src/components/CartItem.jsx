    ...
    const updateQuantity1 = (option) => {
        if(option === '+'){
            dispatch(updateItems({...item, quantity: quantity + 1}))
             ...
             dispatch(updateItems({...item, quantity: quantity < 2 ? dispatch(removeItem(item)) : quantity - 1}))
                ...
                <div className="cart__item__info__quantity">
                    <div className="product__info__item__quantity">
                        ...
                        <div className="product__info__item__quantity-btn">
                            <i className="bx bx-minus" onClick={() => updateQuantity1('-')} ></i>
                        </div>
                        <div className="product__info__item__quantity-input">
                            {quantity}
                        </div>
                        <div className="product__info__item__quantity-btn">
                            <i className="bx bx-plus" onClick={() => updateQuantity1('+')}></i>
                        </div>
                    </div>
                </div>
