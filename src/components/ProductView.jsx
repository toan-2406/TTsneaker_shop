    ...
    return (
        <div className="product">
            ...
            <div className="product__info">
                    ...
                    <div className="product__info__item__list">
                        {
                            product.size.map((item, index) => (
                                <div className={`product__info__item__list__item ${ size === item ? 'active' : '' }`} key={index} onClick={() => setSize(item)}>
                ...
                <div className="product__info__item">
                    <Button size="sm" onClick={() => handleAddtoCart()}>Thêm vào giỏ hàng</Button>
